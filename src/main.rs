...
fn load_ebps(node: &Box<Node>, parent: String, conn: &Connection) {
    ...
    if !node.is_attribute_node() {
        ...
        for subnode in &node.get_all_children() {
            load_ebps(subnode, new_parent.clone(), conn);
        }
    } else {
...
fn load_sbps(node: &Box<Node>, parent: String, conn: &Connection) {
    let mut new_parent = parent.clone();
    ...
    if !node.is_attribute_node() {
        ...
        for subnode in &node.get_all_children() {
            load_sbps(subnode, new_parent.clone(), conn);
        }
    } else {
        //println!("{}", node.get_name());
        let pbgid = node.get_child("uniqueid.pbgid")
...
fn load_upgrade(node: &Box<Node>, parent: String, conn: &Connection) {
    let mut new_parent = parent.clone();
    ...
    if !node.is_attribute_node() {
        ...
        for subnode in &node.get_all_children() {
            load_upgrade(subnode, new_parent.clone(), conn);
        }
    } else {
        //println!("{}", node.get_name());
        let pbgid = node.get_child("uniqueid.pbgid")
        ...
        let screen_name = node.get_child("group.upgrade_bag")
        ...
        let icon_name = node.get_child("group.upgrade_bag")
                            ...
                            .get_value("value");
        let help_text = node.get_child("group.upgrade_bag")
                            .get_child("group.ui_info")
                            .get_child("locstring.help_text")
                            .get_value("value");
        let extra_text = node.get_child("group.upgrade_bag")
                             .get_child("group.ui_info")
...
fn load_abilities(node: &Box<Node>, parent: String, conn: &Connection) {
    let mut new_parent = parent.clone();
    ...
    if !node.is_attribute_node() {
        ...
        for subnode in &node.get_all_children() {
            load_abilities(subnode, new_parent.clone(), conn);
        }
    } else {
        //println!("{}", node.get_name());
        let pbgid = node.get_child("uniqueid.pbgid")
        ...
        let screen_name = node.get_child("group.ability_bag")
                              .get_child("group.ui_info")
                              .get_child("locstring.screen_name")
                              .get_value("value");
        let icon_name = node.get_child("group.ability_bag")
                            ...
                            .get_child("icon.icon_name")
                            .get_value("value");
        let help_text = node.get_child("group.ability_bag")
                            .get_child("group.ui_info")
                            .get_child("locstring.help_text")
                            .get_value("value");
        let extra_text = node.get_child("group.ability_bag")
                             .get_child("group.ui_info")
                             .get_child("locstring.extra_text")
                             .get_value("value");
...
fn load_commander(node: &Box<Node>, parent: String, conn: &Connection) {
    let mut new_parent = parent.clone();
    ...
    if !node.is_attribute_node() {
        ...
        for subnode in &node.get_all_children() {
            load_commander(subnode, new_parent.clone(), conn);
        }
    } else {
        //println!("{}", node.get_name());
        let pbgid = node.get_child("uniqueid.pbgid")
        ...
        let description = node.get_child("group.commander_bag")
...
fn load_intel_bulletin(node: &Box<Node>, parent: String, conn: &Connection) {
    let mut new_parent = parent.clone();
    ...
    if !node.is_attribute_node() {
        ...
        for subnode in &node.get_all_children() {
            load_intel_bulletin(subnode, new_parent.clone(), conn);
        }
    } else {
        //println!("{}", new_parent);
        //println!("{}", node.get_name());
        ...
        let name = node.get_child("group.intel_bag")
                       .get_child("locstring.name")
                       .get_value("value");

        let description = node.get_child("group.intel_bag")
                              .get_child("locstring.description")
                              .get_value("value");
...
fn load_skin_pack(node: &Box<Node>, parent: String, conn: &Connection) {
    let mut new_parent = parent.clone();
    ...
    if !node.is_attribute_node() {
        ...
        for subnode in &node.get_all_children() {
            load_skin_pack(subnode, new_parent.clone(), conn);
        }
    } else {
        //println!("{}", node.get_name());
        let pbgid = node.get_child("uniqueid.pbgid")
        ...
        let name = node.get_child("group.skin_pack_bag")
                       .get_child("locstring.name")
                       .get_value("value");

        let description = node.get_child("group.skin_pack_bag")
                              .get_child("locstring.description")
                              .get_value("value");
...
fn load_faceplate(node: &Box<Node>, parent: String, conn: &Connection) {
    let mut new_parent = parent.clone();
    ...
    if !node.is_attribute_node() {
        ...
        for subnode in &node.get_all_children() {
            load_faceplate(subnode, new_parent.clone(), conn);
        }
    } else {
        //println!("{}", node.get_name());
        let pbgid = node.get_child("uniqueid.pbgid")
        ...
        let name = node.get_child("group.faceplate_bag")
                       .get_child("locstring.name")
                       .get_value("value");
...
fn load_fatality(node: &Box<Node>, parent: String, conn: &Connection) {
    let mut new_parent = parent.clone();
    ...
    if !node.is_attribute_node() {
        ...
        for subnode in &node.get_all_children() {
            load_fatality(subnode, new_parent.clone(), conn);
        }
    } else {
        //println!("{}", node.get_name());
        let pbgid = node.get_child("uniqueid.pbgid")
        ...
        let name = node.get_child("group.fatality_bag")
                       .get_child("locstring.name")
                       .get_value("value");

        let description = node.get_child("group.fatality_bag")
                              .get_child("locstring.description")
                              .get_value("value");
...
fn load_vehicle_decal(node: &Box<Node>, parent: String, conn: &Connection) {
    let mut new_parent = parent.clone();
    ...
    if !node.is_attribute_node() {
        ...
        for subnode in &node.get_all_children() {
            load_vehicle_decal(subnode, new_parent.clone(), conn);
        }
    } else {
        //println!("{}", node.get_name());
        let pbgid = node.get_child("uniqueid.pbgid")
        ...
        let name = node.get_child("group.vehicle_decal_bag")
                       .get_child("locstring.name")
                       .get_value("value");

        let description = node.get_child("group.vehicle_decal_bag")
                              .get_child("locstring.description")
                              .get_value("value");
